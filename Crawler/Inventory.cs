...
public static class CommodityEx {
    ...
    public static EArray<Commodity, CommodityData> Data = [
        ...
        new CommodityData(5.0f, 1.2f, 0.10f, CommodityFlag.Integral, GameTier.Mid, CommodityCategory.Dangerous), // Soldiers
        ...
        new CommodityData(175f, 1.0f, 0.4f, CommodityFlag.None, GameTier.Mid, CommodityCategory.Parts), // Polymers
        new CommodityData(425f, 1.0f, 2.0f, CommodityFlag.None, GameTier.Mid, CommodityCategory.Parts), // Alloys
        new CommodityData(135f, 1.0f, 0.6f, CommodityFlag.None, GameTier.Late, CommodityCategory.Parts), // Electronics
        new CommodityData(430f, 1.0f, 0.7f, CommodityFlag.None, GameTier.Mid, CommodityCategory.Dangerous), // Explosives
        ...
        new CommodityData(12f, 0.001f, 0.0005f, CommodityFlag.None, GameTier.Mid, CommodityCategory.Vice), // Stims
        new CommodityData(10f, 0.001f, 0.0005f, CommodityFlag.None, GameTier.Mid, CommodityCategory.Vice), // Downers
        new CommodityData(36f, 0.001f, 0.0006f, CommodityFlag.None, GameTier.Late, CommodityCategory.Vice), // Trips
        new CommodityData(5.625f, 0.01f, 0.0075f, CommodityFlag.None, GameTier.Mid, CommodityCategory.Dangerous), // SmallArms

        // Religious items
        new CommodityData(6.0f, 0.003f, 0.004f, CommodityFlag.Integral, GameTier.Early, CommodityCategory.Religious), // Idols
        new CommodityData(4.0f, 0.005f, 0.002f, CommodityFlag.Integral, GameTier.Early, CommodityCategory.Religious), // Texts
        new CommodityData(15.0f, 0.002f, 0.003f, CommodityFlag.Integral, GameTier.Late, CommodityCategory.Religious), // Relics
    ];
